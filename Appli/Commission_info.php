...
<br>
	...
	<div class="container col-md-7 py-5">
        ...
        <h4 class="text-center">
            ...
            Your commission will be registered to the<a href="https://trello.com/b/LtuEpOXQ/wait-list" style="color: #EB5E5E">[Wait-List]</a>as soon as the payement is sended.<br><br>
        ...
        <br><br>
        <h2 class="text-center"><a href="https://trello.com/b/LtuEpOXQ/wait-list" style="color: #EB5E5E">Wait-List</a></h2><br><br>
